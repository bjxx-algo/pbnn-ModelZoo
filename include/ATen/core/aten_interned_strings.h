...
_(aten, _linalg_det) \
_(aten, _linalg_eigh) \
_(aten, _linalg_inv_out_helper) \
_(aten, _linalg_inv_out_helper_) \
...
_(aten, _mps_linear) \
_(aten, _mps_linear_backward_input) \
_(aten, _mps_linear_backward_weights) \
...
_(aten, _reshape_nested) \
_(aten, _reshape_nested_backward) \
