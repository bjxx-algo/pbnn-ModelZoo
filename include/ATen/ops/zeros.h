...
// aten::zeros.SymInt(SymInt[] size, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None) -> Tensor
inline at::Tensor zeros_symint(c10::SymIntArrayRef size, at::TensorOptions options={}) {
    return at::_ops::zeros_SymInt::call(size, optTypeMetaToScalarType(options.dtype_opt()), options.layout_opt(), options.device_opt(), options.pinned_memory_opt());
}
...
inline at::Tensor zeros_symint(c10::SymIntArrayRef size, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout, c10::optional<at::Device> device, c10::optional<bool> pin_memory) {
    return at::_ops::zeros_SymInt::call(size, dtype, layout, device, pin_memory);
}
...
// aten::zeros.SymInt_out(SymInt[] size, *, Tensor(a!) out) -> Tensor(a!)
inline at::Tensor & zeros_symint_out(at::Tensor & out, c10::SymIntArrayRef size) {
    return at::_ops::zeros_SymInt_out::call(size, out);
}
