...
// aten::new_empty.out(Tensor self, int[] size, *, Tensor(a!) out) -> Tensor(a!)
...
// aten::new_empty.SymInt_out(Tensor self, SymInt[] size, *, Tensor(a!) out) -> Tensor(a!)
inline at::Tensor & new_empty_symint_out(at::Tensor & out, const at::Tensor & self, c10::SymIntArrayRef size) {
    return at::_ops::new_empty_SymInt_out::call(self, size, out);
}
