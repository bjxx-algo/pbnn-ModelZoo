...
// aten::view_copy.SymInt(Tensor self, SymInt[] size) -> Tensor
inline at::Tensor view_copy_symint(const at::Tensor & self, c10::SymIntArrayRef size) {
    return at::_ops::view_copy_SymInt::call(self, size);
}

// aten::view_copy.out(Tensor self, int[] size, *, Tensor(a!) out) -> Tensor(a!)
...
// aten::view_copy.SymInt_out(Tensor self, SymInt[] size, *, Tensor(a!) out) -> Tensor(a!)
inline at::Tensor & view_copy_symint_out(at::Tensor & out, const at::Tensor & self, c10::SymIntArrayRef size) {
    return at::_ops::view_copy_SymInt_out::call(self, size, out);
}
