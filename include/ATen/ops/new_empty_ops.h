...
struct TORCH_API new_empty_SymInt {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "new_empty.SymInt(Tensor self, SymInt[] size, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None) -> Tensor")
...
struct TORCH_API new_empty_out {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "new_empty.out(Tensor self, int[] size, *, Tensor(a!) out) -> Tensor(a!)")
...
struct TORCH_API new_empty_SymInt_out {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "new_empty.SymInt_out(Tensor self, SymInt[] size, *, Tensor(a!) out) -> Tensor(a!)")
