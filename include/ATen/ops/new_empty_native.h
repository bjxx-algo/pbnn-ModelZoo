...
TORCH_API at::Tensor & new_empty_out(const at::Tensor & self, at::IntArrayRef size, at::Tensor & out);
...
TORCH_API at::Tensor & new_empty_SymInt_out(const at::Tensor & self, c10::SymIntArrayRef size, at::Tensor & out);
} // namespace native
} // namespace at
